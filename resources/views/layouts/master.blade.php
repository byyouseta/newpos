...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{ asset('template/dist/assets/images/cashier-favicon.png') }}" type="image/x-icon">

    <!-- vendor css -->
    <link rel="stylesheet" href="{{ asset('template/dist/assets/css/style.css') }}">
    <!-- SweetAlert2 -->
    <link rel="stylesheet"
        href="{{ asset('template/dist/assets/plugin/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css') }}">
    @yield('styles')
</head>
...
<body class="">
            ...
            <div class="navbar-content scroll-div ">
                ...
                <div class="">
                    <div class="main-menu-header">
                        <img class="img-radius" src="{{ asset('template/dist/assets/images/user/cashier.png') }}"
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
        <div class="m-header">
            ...
            <a href="{{ route('home') }}" class="b-brand">
                ...
                <img src="{{ asset('template/dist/assets/images/cashier.png') }}" alt="" class="logo"
                    height="32">
                <div class="ml-2 h4 mt-2">newPOS</div>
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="#!"> <img src="{{ asset('template/dist/assets/images/menu/cashier-icon.png') }}"
                            alt="" height="24"></a>
                </li>
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="{{ asset('template/dist/assets/images/user/cashier.png') }}"
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">{{ session('ibu') }}</h5>
                            </div>
                            <ul class="breadcrumb">
                                ...
                                @if (session('anak'))
                                    <li class="breadcrumb-item"><a href="#!">{{ session('anak') }}</a></li>
                                @endif
                                @if (session('cucu'))
                                    <li class="breadcrumb-item"><a href="#!">{{ session('cucu') }}</a></li>
                                @endif
                            </ul>
                        </div>
                    </div>
    ...
    <!-- SweetAlert2 -->
    <script src="{{ asset('template/dist/assets/plugin/sweetalert2/sweetalert2.min.js') }}"></script>
